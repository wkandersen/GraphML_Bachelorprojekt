...
torch.save(paper_dict, "dataset/ogbn_mag/processed/paper_dict.pt")
torch.save(venue_dict, "dataset/ogbn_mag/processed/venue_dict.pt")

emb_matrix = torch.stack(list(paper_dict.values()) + list(venue_dict.values()))

torch.save(emb_matrix, "dataset/ogbn_mag/processed/emb_matrix.pt")
