...
export WANDB_DIR="/work3/s224225/wandb"
nvidia-smi 
...
python src/model1/embed_valid_3.py
# python src/model1/syntetic_data/syn_embed_valid.py
# python Packages/plot_embeddings.py
...
python src/model1/syntetic_data/sweep.py